...
String assemblyTwo = "assembly2\n";
String assemblyThree = "assembly input\n";
String adding = "adding\n";
String voltageDivider = "voltage divider\n";
String controlInput = "switch input\n";
String sleepingOne = "sleep 4\n";
String sleepingTwo = "sleep 16\n";
String sleepingThree = "sleep time\n";
...
void choices(){
   ...
   else if(inputString == assemblyThree){
      assemblySetup(num1, num2);
      num1++;
      num2++;
   }
   ...
   else if(inputString == sleepingTwo){
      sleepingTimeTwo();
   }
