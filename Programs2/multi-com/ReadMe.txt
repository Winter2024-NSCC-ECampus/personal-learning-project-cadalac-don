Install program onto the Arduino. This is a basic test to include assembly into the Arduino IDE. 

Open the program with the Arduino IDE. Install program onto the Arduino. Some projects have files that are connect to the main INO File for a working program.

You can use the serial monitor in the Arduino IDE to keep track of the print lines and sent lines to the Arduino. Otherwise, you can use a RS232 attachment and use PuTTy or equivalent.
